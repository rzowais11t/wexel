...
const PrismaticBurst = ({
  ...
  useEffect(() => {
    ...
    // Use a maximum dpr of 1 to prevent lag on high-DPI (Retina) displays
    ...
    const resize = () => {
      ...
      // Scale down the internal drawing resolution for better performance
      const scale = 0.5;
      renderer.setSize(w * scale, h * scale);
      
      // Ensure the canvas stretches to fill the container visually
      gl.canvas.style.width = '100%';
      gl.canvas.style.height = '100%';
